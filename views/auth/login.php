...
<body class="bg-zinc-900">
    ...
    <div class="min-h-screen flex items-center justify-center py-12">
        ...
        <div class="w-full max-w-[480px] px-4 fade-in-up">
            
            <div class="relative bg-black/20 backdrop-blur-xl border border-white/10 p-8 md:p-10 rounded-3xl shadow-2xl ring-1 ring-white/5">
                
                <div class="absolute -top-20 -right-20 w-60 h-60 bg-white/5 rounded-full blur-3xl pointer-events-none opacity-50"></div>

                <div class="relative">
                    <h2 class="text-3xl font-bold text-white mb-2 font-sunda text-center">Login</h2>
                    <p class="text-gray-400 text-sm mb-6 text-center">Access your reservation at Pasundan Resort.</p>

                    <?php if(isset($_GET['msg'])): ?>
                        <div class="mb-6 p-4 rounded-xl bg-red-900/30 border border-red-500/30 text-red-200 text-sm flex items-center gap-3 animate-pulse">
                    ...
                    <form action="index.php?aksi=login_proses" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="username" required
                                        class="w-full pl-12 pr-4 py-4 bg-black/30 border border-white/10 rounded-2xl text-white placeholder-gray-600 focus:outline-none focus:border-white/30 focus:bg-black/50 focus:ring-1 focus:ring-white/30 transition-all duration-300"
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <label class="flex items-center cursor-pointer group">
                                <div class="relative">
                                    ...
                                    <div class="w-10 h-6 bg-white/10 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-black after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-gray-400 after:border-gray-500 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-white peer-checked:after:bg-black"></div>
                                </div>
                                <span class="ml-3 text-gray-400 group-hover:text-white transition">Ingat Saya</span>
                            </label>
                            <a href="#" class="text-gray-400 hover:text-white font-medium transition underline decoration-gray-600 hover:decoration-white">Lupa Password?</a>
                        </div>

                        <button type="submit" 
                            class="w-full py-4 bg-white rounded-2xl text-black font-bold text-lg shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.3)] hover:bg-gray-200 hover:-translate-y-1 transition-all duration-300 transform">
                            Masuk Sekarang
                        </button>
                    </form>
                     ...
                     <div class="relative my-6">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="px-2 text-gray-500 bg-transparent">Atau masuk dengan</span>
                            </div>
                        </div>

                        <div class="flex justify-center space-x-4">
                            <a href="#" class="p-3 bg-black/30 border border-white/10 rounded-xl hover:bg-white/10 hover:border-white/30 transition-all group">
